...
import { Frame, Group, Item, KIND_SPEC, KINDS, Palette, explodeGroup, isPhoneFrame } from "@/lib/tokens";
...
function nameOf(it: Item, lang: Lang) {
  ...
  return it.label.trim() || (it.kind === KINDS.iconButton || it.kind === KINDS.fab ? (it.icon ?? noun) : noun);
}
